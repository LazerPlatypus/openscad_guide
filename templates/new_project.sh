#!/usr/bin/env bash
# OpenSCAD Project Template Setup Script
# Creates a new OpenSCAD design project from the template
...
# Banner
print_header "OpenSCAD Project Template Setup"
echo "This script will help you create a new OpenSCAD design project."
echo ""

# Gather information
read -p "Project name (e.g., hockey_puck_display): " PROJECT_NAME
...
read -p "Build STL files now? (y/N): " RUN_BUILD
if [[ "$RUN_BUILD" =~ ^[Yy]$ ]]; then
    print_step "Building STL files..."
    make
...
echo ""
echo "Your new project is ready at: ${GREEN}$DEST_DIR${NC}"
echo ""
echo "Next steps:"
echo "  1. cd $DEST_DIR"
echo "  2. Replace example parts in models/ with your design"
echo "  3. Update config.scad with your dimensions"
echo "  4. Run 'make' to build STL files"
